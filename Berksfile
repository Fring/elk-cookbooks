...
cookbook 'opsworks_elasticsearch', '~> 0.1.0', git: 'git://github.com/Fring/chef-opsworks-elasticsearch.git'
cookbook 'opsworks_kibana', '~> 0.1.0', git: 'git://github.com/Fring/chef-opsworks-kibana.git'
cookbook 'opsworks_logstash', '~> 0.1.0', git: 'git://github.com/Fring/chef-opsworks-logstash.git'
